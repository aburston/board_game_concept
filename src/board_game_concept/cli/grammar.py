...
USAGES = (
    ...
    Usage('remove_unit', ('remove', 'unit', Slot('unit', UNIT)),
          'take back one of your units, before your setup is committed'),
    ...
    _show('placement', 'show where you may deploy units during setup'),
    Usage('move', ('move', Slot('unit', UNIT),
                   Slot('|'.join(DIRECTIONS), DIRECTION)),
          'order one of your units to move'),
    Usage('hold', ('hold', Slot('unit', UNIT)),
          'take back the order one of your units was given this turn'),
    Usage('commit', ('commit',),
          'commit the actions you have taken; this cannot be undone'),
    Usage('reload', ('reload',),
          'read the game again from disk'),
    Usage('login', ('login', Optional(Slot('username', NAME))),
          'sign in, so that what you ask for is asked in your name'),
    Usage('logout', ('logout',),
          'end the session you signed in for'),
    Usage('whoami', ('whoami',),
          'say which account this session is signed in as'),
    Usage('passwd', ('passwd',),
